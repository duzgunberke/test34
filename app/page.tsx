...
const teamMembers = [
  {
    ...
    name: "Sarah Johnson",
    role: "CEO & Founder",
    bio: "Visionary leader with 10+ years in strategic planning and business development. Passionate about building innovative solutions.",
  ...
  },
  {
    ...
    name: "Michael Chen",
    role: "CTO",
    bio: "Technology expert specializing in scalable architecture and emerging technologies. Drives our technical innovation forward.",
  ...
  },
  {
    ...
    role: "Head of Design",
    bio: "Creative director with expertise in user experience and brand identity. Creates compelling visual narratives.",
  ...
  },
  {
    ...
    name: "David Kim",
    role: "Lead Developer",
    bio: "Full-stack developer passionate about clean code and performance optimization. Builds robust, scalable solutions.",
  ...
  },
  {
    ...
    bio: "Strategic marketer with deep expertise in digital campaigns and brand growth. Amplifies our message globally.",
  ...
  },
  {
    ...
    bio: "Operations specialist focused on process optimization and team efficiency. Ensures seamless project delivery.",
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex-shrink-0">
              <h1 className="text-2xl font-bold text-blue-600 font-serif">TeamLogo</h1>
            </div>
      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 font-serif leading-tight animate-fade-in">
            ...
            <br />
            <span className="text-blue-600">Driving Success</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
            Meet our dedicated team, committed to excellence and innovation in everything we do.
          </p>
          <Button
      ...
      <section id="about" className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 font-serif">About Us</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We are a dynamic team of professionals dedicated to delivering exceptional results through collaboration,
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-2xl font-semibold text-gray-900 mb-3 font-serif">Our Story</h3>
                <p className="text-gray-600 leading-relaxed">
                  Founded with a vision to transform how teams collaborate and achieve their goals, we have grown into a
                  trusted partner for organizations seeking innovative solutions and exceptional service delivery.
                </p>
              </div>
              <div>
                <h3 className="text-2xl font-semibold text-gray-900 mb-3 font-serif">Experience That Matters</h3>
                <p className="text-gray-600 leading-relaxed">
                  With over <span className="font-semibold text-blue-600">15 years</span> of combined experience across
                  diverse industries, our team brings deep expertise and fresh perspectives to every project we
                  undertake.
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-8 border-l-4 border-l-blue-600 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-0">
                <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-serif">Our Mission</h3>
                <p className="text-gray-600 leading-relaxed">
                  To empower teams and organizations by providing innovative solutions, fostering collaboration, and
                  delivering exceptional results that drive sustainable growth and success.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="p-8 border-l-4 border-l-cyan-500 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-0">
                <h3 className="text-2xl font-semibold text-gray-900 mb-4 font-serif">Our Goals</h3>
                <p className="text-gray-600 leading-relaxed">
                  To continuously innovate, expand our expertise, and build lasting partnerships while maintaining our
                  commitment to quality, integrity, and client satisfaction in everything we do.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section id="team" className="py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 font-serif">Our Team</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Meet the talented individuals who drive our success. Each member brings unique expertise and passion to
          ...
          <div className="text-center mt-12">
            <p className="text-gray-600 mb-6">Want to learn more about our team members?</p>
            <Button
      ...
      <section id="updates" className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 font-serif">Insights & Updates</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Stay informed with our latest thoughts, industry insights, and updates from our team of experts.
            </p>
          </div>
      ...
      <section id="contact" className="py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 font-serif">Get in Touch</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-2xl font-semibold text-gray-900 mb-6 font-serif">Let's Connect</h3>
                <p className="text-gray-600 leading-relaxed mb-8">
                  Whether you're looking to collaborate, need expert consultation, or want to learn more about our
                  services, we're here to help. Reach out through any of the channels below or use the contact form.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@teamlogo.com</p>
            ...
            <Card className="bg-white shadow-xl border-0">
              <CardContent className="p-8">
                <h3 className="text-2xl font-semibold text-gray-900 mb-6 font-serif">Send us a Message</h3>
                <ContactForm />
              </CardContent>
            </Card>
          </div>
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {submitStatus === "error" && (
        <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
          ...
          <p className="text-red-700 text-sm mt-1">Please try again or contact us directly at hello@teamlogo.com</p>
        </div>
      )}
